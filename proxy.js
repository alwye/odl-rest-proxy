...
var appConfig = {
	// Controller settings
	'ctrlHost': '', // Controller's IP address
	'ctrlPort': '8181', // Controller's Port (8181 by default)
	'ctrlUsername': 'admin', // User name to access the controller
	'ctrlPassword': 'admin', // User's password to access the controller
	// Proxy settings
	'proxyPort': 5555
};
